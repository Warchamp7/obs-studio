...
private:
	...
	void createThumbnailItem(std::string &uuid, OBSSource &source);
	QPointer<ThumbnailItem> getThumbnailItem(OBSSource &source);

private slots:
	void updateTick();
	void addToPriorityQueue(std::string &uuid);
