	  ...
	  manager_(App()->getSettingsManager())
{
	...
	connect(this, &AbstractSettingsSection::pageCreated, this, &AbstractSettingsSection::create);
}
...
void AbstractSettingsSection::create()
{
	hasPendingChanges = false;
}
...
void AbstractSettingsPage::pageActive(bool isActive) {}
