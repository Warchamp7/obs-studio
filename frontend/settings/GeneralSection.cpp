	  ...
	  ui(new Ui::GeneralPage)
{
	...
	connect(&section(), &AbstractSettingsSection::pageActivated, this, &GeneralWidget::pageActive);
...
GeneralWidget::~GeneralWidget()
{
	...
	disconnect(&section(), &AbstractSettingsSection::pageActivated, this, &GeneralWidget::pageActive);
...
void GeneralWidget::initialLoad()
{
	...
	if (basicWindow) {
		...
		bindChangeCallback("BasicWindow", "SnappingEnabled", [this]() {
...
void GeneralWidget::pageActive(bool isActive)
{
	if (isActive) {
	}
}
